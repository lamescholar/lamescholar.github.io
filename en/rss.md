...
RSS is XML file that keeps track of publications on the website. When you open it using RSS reader, you get a feed of recent publications. RSS feeds are usually generated by [blogs](/en/blogs), [newspapers](/en/newspapers), and [magazines](/en/articles).
<br><br>

Good RSS reader:<br>
yet another rss reader - <https://github.com/nkanaev/yarr>

To make it start with the system:<br>
Win+R<br>
shell:startup<br>
Paste shortcut of .exe file. Now yarr will start with the system.<br>

You can make a bookmark in browser for address <http://127.0.0.1:7070/>

Database of the program is located in AppData\Roaming\yarr
<br><br>
...
Installing Cygwin, select to install make.
...
Or isntall altest release: [yarr_windows_amd64_gui.zip](https://github.com/nkanaev/yarr/releases)
<br><br>
