...
RSS is a file that keeps track of publications on the website. When you open it using RSS reader, you get a feed of recent publications. RSS feeds are usually generated by [blogs](/en/blogs), [newspapers](/en/newspapers), and [magazines](/en/articles).
<br><br>

A good RSS reader:<br>
yet another rss reader - <https://github.com/nkanaev/yarr>

To start it with the system:<br>
Win+R<br>
shell:startup<br>
Paste shortcut of .exe file. Now yarr will start with the system.<br>

You can make a bookmark in the browser for the address <http://127.0.0.1:7070/>
