...
[Jekyll](https://jekyllrb.com/) is a static site generator. You need to find a hosting. I use [GitHub Pages](https://pages.github.com/). It's free hosting that supports Jekyll. The size limit is 1 GB.
<br><br>
...
<07>
Highlight a link: <link>

<08>
Link: [text](link)

<09>
Link to site page: [text](/folder/page)
...
<14>
Blank line (double line break): <br><br>
...
```
cd username.github.io
bundle add webrick csv logger base64
```
...
Go to minima folder. On Windows it is located in user folder:

.local/share/gem/ruby/3.4.0
