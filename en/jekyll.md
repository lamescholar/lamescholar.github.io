...
[Jekyll](https://jekyllrb.com/) is static site generator. I use [GitHub Pages](https://pages.github.com/), free hosting from GitHub that supports Jekyll. The size limit is 1 GB.
<br><br>
