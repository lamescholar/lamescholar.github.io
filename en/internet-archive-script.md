...
layout: page
comments: true
title: Internet Archive script
---

<https://github.com/MiniGlome/Archive.org-Downloader>
<br><br>

Internet Archive has scanned a lot of books. With this Python script you can download any book from Internet Archive. The script downloads the photos of the book. There are three options how you can encode the images into PDF or DjVu, I list them in the end.
