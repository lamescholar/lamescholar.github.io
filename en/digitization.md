...
Before digitization check if the book is already on the Internet. Look Book searching.txt. How to get a book for scanning? Get it in the library. If a big local library allows reading only inside the library, ask if there is a paid service of photographing, and if there is, photo a book inside the library. If you didn't find required book in the libraries, then buy it.
