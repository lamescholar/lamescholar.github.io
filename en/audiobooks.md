...
2. Translate subtitles (1.srt) from German to English with [Subtitle Edit](https://github.com/SubtitleEdit/subtitleedit/releases) + [LM Studio](https://lmstudio.ai/) + Qwen3-4B (2.srt).
