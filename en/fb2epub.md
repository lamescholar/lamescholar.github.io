...
Esc - menu. Alt+Left - return to the previous position in the book. The font size is usually 15 px. Preferences. Page Layout->Landscape: 1. Scrolling behavior->Miscellaneous->Show scrollbar. Miscellaneous->Remember last used window size and position.
