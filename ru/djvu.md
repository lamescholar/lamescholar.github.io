...
Это исчерпывающая сборка программ для создания, редактирования и чтения DjVu-книг. С ее помощью ты можешь создать электронную книгу в формате djvu с OCR-слоем (текстовым слоем) и содержанием.<br/><br/>

Функции программ:<br/><br/>
...
Book Restorer - программа для выпрямления искривлённых изображений. Создаём Book. Если нужно, можно оставить исходные имена файлов: Standart page->Properties->Numbering->Original name. Tools->Restore. Geometrical correction. Publish (иконка диска в меню). При распрямлении чёрно-белых изображений в графе Types of files выбири G4-compressed, в графе Color range - Binary. Если нужно распрямить текст книжки с иллюстрациями, то в программу нужно закинуть полученные из Scan Tailor цветные изображения. При выводе в графе Types of files выбираем TIFF LZW compressed, в графе Color range - RGB colors. Распрямлённые изображения разбиваем на текст и иллюстрации в Scan Tailor. Чтобы программа не вылетала при обработке изображений, много весящих в совокупности, необходимо зайти в Preferences и выбрать сжатие JPEG 10% для временных файлов. Если результирующее изображение получилось искривлённым, замени его на исходное изображение.
...
Djvu Small Mod + DjVu Imager и FSD реализуют метод разделённых сканов. Изображения разбиваются на текст и иллюстрации, которые кодируются отдельно.<br/><br/>
...
12) Document Express Editor 6.0.1 - редактирование гиперссылок.<br/><br/>
