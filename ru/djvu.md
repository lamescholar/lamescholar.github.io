...
Сборка программ для создания, редактирования и чтения DjVu-файлов. С ее помощью ты можешь создать электронную книгу в формате DjVu с OCR-слоем (текстовым слоем) и содержанием.
<br><br>
