...
С помощью этого скрипта вы можете скачивать книги из Internet Archive. Скрипт использует 1 час книговыдачи для загрузки страниц книги. Для преобразования изображений в PDF скрипт использует пакет img2pdf. Но он создает очень большой файл PDF. Поэтому я рекомендую вам сохранить параметр -j в конце команды, чтобы вы получали только изображения. Ниже указаны три варианта того, как вы можете эффективно конвертировать их в PDF или DjVu.<br/><br/>
