...
При создании PDF шрифт размывается и становится толще, поэтому вместо Arial лучше использовать Times New Roman. Применяшь набор стилей Times New Roman. Сохранить как Adobe PDF. В настройках расширения отключи создание закладок.