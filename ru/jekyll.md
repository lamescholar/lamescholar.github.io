...
[Jekyll](https://jekyllrb.com/) - это генератор статических сайтов. Он превращает Markdown-файлы в полностью стилизированные HTML-страницы. Я использую [GitHub Pages](https://pages.github.com/). Это бесплатный хостинг, который поддерживает Jekyll. Лимит - 1 ГБ.
<br><br>
