...
[Jekyll](https://jekyllrb.com/) - это генератор статических сайтов. Он превращает группу Markdown-файлов в полностью стилизированные HTML-страницы. Я использую [GitHub Pages](https://pages.github.com/). Это бесплатный хостинг, который поддерживает Jekyll. Лимит - 1 ГБ.
<br><br>
...
<09>
Ссылка на страницу сайта: [текст](/папка/страница)
...
<14>
Пустая строка (двойной разрыв строки): <br><br>
