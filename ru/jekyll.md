...
[Jekyll](https://jekyllrb.com/) - это генератор статических сайтов. В пару к нему нужен хостинг. Я использую [GitHub Pages](https://pages.github.com/). Это бесплатный хостинг, который поддерживает Jekyll. Лимит - 1 ГБ.
<br><br>
