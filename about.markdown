...
Pirate Cookbook is my collection of guides to demystify technologies that we use every day.

Здесь я делюсь своими мыслями и источниками что нахожу онлайн. Я сделал этот блог с помощью [Jekyll](/ru/jekyll).<br>
Поваренная книга пирата - моя коллекция гайдов, чтобы демистифицировать технологии, которыми мы пользуемся каждый день.
<br><br>
